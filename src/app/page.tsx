...
export default function Home() {
  return (
    <main className="min-h-screen bg-background flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-border">
      ...
      <Link href="/catalog" className="flex-1 group relative flex items-center justify-center min-h-[33vh] md:min-h-screen hover:bg-muted/50 transition-colors duration-500">
        <div className="text-center z-10 p-8">
          ...
          <p className="text-xs text-muted-foreground uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
            Current Collection
          </p>
        </div>
      </Link>
